---
title: "6: Create animated data visualizations"
format: gfm
---

## Turning your data visuals into animated gifs

This one is just for fun. R might not be your go-to tool for making animated gifs. But you can! 

Consider this New York Times graphic:

![Swimmers](https://lenagroeger.com/datagifs/img/swim2.gif)

On a whim, I asked Claude to create a similar graphic using the R library `magick` and data on the [fastest female 100-meter sprinters](https://worldathletics.org/records/all-time-toplists/sprints/100-metres/outdoor/women/senior). I've tweaked the code just a little, but here's what it came up with -- a minimal viable product that you could easily refine for publication.  
...
[Lena Groeger](https://www.propublica.org/people/lena-groeger), the graphics director at ProPublica, has a great collection of [data visuals that are animated gifs](https://lenagroeger.com/datagifs/#/). That's where I found the swimmers example mentioned above.  
